Contributing to zibiz Core
============================

The zibiz Core project operates an open contributor model where anyone is
...
The following applies to code changes to the zibiz Core project, and is not to be
confused with overall zibiz Network Protocol consensus changes.

Whether a pull request is merged into zibiz Core rests with the project merge
...
Patches that change zibiz consensus rules are considerably more involved than
...
Where a patch set proposes to change the zibiz consensus, it must have been
...
The project leader is the release manager for each zibiz Core release.
