...
/* zibiz GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "zibiz"
#define QAPP_ORG_DOMAIN "zibizproject.org"
#define QAPP_APP_NAME_DEFAULT "zibiz-Qt"
#define QAPP_APP_NAME_TESTNET "zibiz-Qt-testnet"
