                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("zibiz Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&zibiz Project"), this);
    webmainAction->setStatusTip(tr("zibiz Project Website"));
    ...
    facebookAction->setStatusTip(tr("zibiz Facebook"));
    ...
    twitterAction->setStatusTip(tr("zibiz Twitter"));
    ...
    discordAction->setStatusTip(tr("zibiz Discord"));
    ...
    youtubeAction->setStatusTip(tr("zibiz Youtube"));
    ...
    telegramAction->setStatusTip(tr("zibiz Telegram"));
    ...
    redditAction->setStatusTip(tr("zibiz Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap zibiz"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell zibiz Coin (zibiz)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    zibizBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&zibiz block explorer"), this);
    zibizBlockExplorerAction->setStatusTip(tr("zibiz blockchain explorer"));
    zibizBlockExplorerAction->setToolTip(zibizBlockExplorerAction->statusTip());
    zibizBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&zibiz Project Github"), this);
    githubAction->setStatusTip(tr("zibiz Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a zibiz address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zibiz: URIs)"));
...
//    }
    ...
    connect(zibizBlockExplorerAction, SIGNAL(triggered()), this, SLOT(zibizBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About zibiz Core"), this);
    aboutAction->setStatusTip(tr("Show information about zibiz Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for zibiz"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your zibiz addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified zibiz addresses"));
    ...
    openAction->setStatusTip(tr("Open a zibiz: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the zibiz Core help message to get a list with possible zibiz command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(zibizBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("zibiz Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.zibiz.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/zibiz.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/zibiz4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/zibizcryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/zibiz-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::zibizBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/zibiz/zibiz/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to zibiz network", "", count));
}
...
{
    QString strTitle = tr("zibiz Core"); // default title
