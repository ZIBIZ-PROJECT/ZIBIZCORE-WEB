...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::zibiz);
    ...
    if (!settings.contains("nAnonymizezibizAmount"))
        settings.setValue("nAnonymizezibizAmount", 1000);

    nAnonymizezibizAmount = settings.value("nAnonymizezibizAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizezibizAmount"))
        SoftSetArg("-anonymizezibizamount", settings.value("nAnonymizezibizAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in zibiz.cpp during shotdown to also remove the window positions
...
//            return settings.value("fShowMasternodesTab");
        ...
        case AnonymizezibizAmount:
            return QVariant(nAnonymizezibizAmount);
        case Listen:
...
//            break;
        ...
        case AnonymizezibizAmount:
            nAnonymizezibizAmount = value.toInt();
            settings.setValue("nAnonymizezibizAmount", nAnonymizezibizAmount);
            emit anonymizezibizAmountChanged(nAnonymizezibizAmount);
            break;
        case CoinControlFeatures:
