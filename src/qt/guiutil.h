...
/** Utility functions used by the zibiz Qt UI.
 */
namespace GUIUtil
{
...
// Render zibiz addresses in monospace font
...
// Parse "zibiz:" URI into recipient object, return true on successful parsing
