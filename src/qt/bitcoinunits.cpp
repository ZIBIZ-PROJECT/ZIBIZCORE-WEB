...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case zibiz:
        return QString("zibiz");
    case mECA:
        return QString("mzibiz");
    case uECA:
        return QString::fromUtf8("uzibiz");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case zibiz:
            return QString("zibiz");
        case mECA:
            return QString("Milli-zibiz (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-zibiz (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
