...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* zibiz features */
        {"zibiz", "masternode", &masternode, true, true, false},
        {"zibiz", "listmasternodes", &listmasternodes, true, true, false},
        {"zibiz", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zibiz", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zibiz", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"zibiz", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"zibiz", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"zibiz", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zibiz", "masternodedebug", &masternodedebug, true, true, false},
        {"zibiz", "startmasternode", &startmasternode, true, true, false},
        {"zibiz", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zibiz", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zibiz", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zibiz", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zibiz", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zibiz", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zibiz", "mnbudget", &mnbudget, true, true, false},
        {"zibiz", "preparebudget", &preparebudget, true, true, false},
        {"zibiz", "submitbudget", &submitbudget, true, true, false},
        {"zibiz", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zibiz", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zibiz", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zibiz", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zibiz", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zibiz", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zibiz", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zibiz", "checkbudgets", &checkbudgets, true, true, false},
        {"zibiz", "mnsync", &mnsync, true, true, false},
        {"zibiz", "spork", &spork, true, true, false},
        {"zibiz", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> zibiz-cli " + methodname + " " + args + "\n";
}
