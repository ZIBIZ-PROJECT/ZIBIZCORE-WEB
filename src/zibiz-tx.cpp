...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("zibiz zibiz-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zibiz-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zibiz transaction") + "\n" +
                               "  zibiz-tx [options] -create [commands]   " + _("Create hex-encoded zibiz transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zibiz transaction
