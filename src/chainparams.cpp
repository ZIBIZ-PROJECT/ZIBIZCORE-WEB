...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "zibiz is born";
...
*/
        ...
        assert(genesis.hashMerkleRoot == uint256("0xdd1a43380885377289b2db500e6034796d7dd720c6f98bee73fb05ee375631b0"));
        assert(hashGenesisBlock == uint256("0x000000ab1299e22cabf58c036bced1509258cd799ed4183d211be76eb0b022a2"));

     
		
	vSeeds.push_back(CDNSSeedData("1", "161.35.137.131"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xdd1a43380885377289b2db500e6034796d7dd720c6f98bee73fb05ee375631b0"));
        assert(hashGenesisBlock == uint256("0x00009bf988dd0d802760ccbd2944206caf916f4e63fb3e23fcd7866521761b08"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xdd1a43380885377289b2db500e6034796d7dd720c6f98bee73fb05ee375631b0"));
        assert(hashGenesisBlock == uint256("0x3680aa68ad383bd22d09709300e369905d9696c27235ec51ecd7474c11c12798"));
