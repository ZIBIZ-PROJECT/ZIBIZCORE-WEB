...
RESOURCES += src/qt/zibiz.qrc src/qt/zibiz_locale.qrc

TRANSLATIONS += src/qt/locale/zibiz_bg.ts \
                src/qt/locale/zibiz_de.ts \
                src/qt/locale/zibiz_en.ts \
                src/qt/locale/zibiz_es.ts \
                src/qt/locale/zibiz_fi.ts \
                src/qt/locale/zibiz_fr.ts \
                src/qt/locale/zibiz_it.ts \
                src/qt/locale/zibiz_ja.ts \
                src/qt/locale/zibiz_pl.ts \
                src/qt/locale/zibiz_pt.ts \
                src/qt/locale/zibiz_ru.ts \
                src/qt/locale/zibiz_sk.ts \
                src/qt/locale/zibiz_sv.ts \
                src/qt/locale/zibiz_vi.ts \
                src/qt/locale/zibiz_zh_CN.ts \
                src/qt/locale/zibiz_zh_TW.ts
