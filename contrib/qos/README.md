...
This means one can have an always-on zibizd instance running, and another local zibizd/zibiz-qt instance which connects to this node and receives blocks from it.
