...
In order to support loading of multiple wallets in zibiz-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zibiz.cpp.
...
Changes to zibiz.cpp
----------------------
zibiz.cpp is the entry point into zibiz-qt, and as such, will require some minor modifications to provide hooks for
